...
namespace NerjaLogisticsERP.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("NerjaLogisticsERP Domain Event: {DomainEvent}", notification.GetType().Name);
