...
public class ExportInventoryLedgerReportQueryValidator : AbstractValidator<ExportInventoryLedgerReportQuery>
{
    public ExportInventoryLedgerReportQueryValidator()
    {
