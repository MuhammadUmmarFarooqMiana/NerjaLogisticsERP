    ...
    public partial class InitialDomainModelWithRefreshTokenFlowAndProfileSubmissionFlow : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Employees_Platforms_PlatformId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleAccidentHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleAccidentHistories_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "VehicleOilChangeHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    VehicleId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleOilChangeHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleOilChangeHistories_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "VehicleTyreReplacementHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    VehicleId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReplacementDate = table.Column<DateOnly>(type: "date", nullable: false),
                    Odometer = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleTyreReplacementHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleTyreReplacementHistories_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "VehicleAllocationHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    VehicleId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleAllocationHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleAllocationHistories_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VehicleAllocationHistories_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleAccidentHistories_VehicleId",
                table: "VehicleAccidentHistories",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleAllocationHistories_EmployeeId",
                table: "VehicleAllocationHistories",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleAllocationHistories_VehicleId",
                table: "VehicleAllocationHistories",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleOilChangeHistories_VehicleId",
                table: "VehicleOilChangeHistories",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleTyreReplacementHistories_VehicleId",
                table: "VehicleTyreReplacementHistories",
                column: "VehicleId");
        }
