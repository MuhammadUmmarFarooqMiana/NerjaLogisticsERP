        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InventoryItems_CurrentStock_NonNegative", "\"CurrentStock\" >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockIns_InventoryItems_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockOuts_InventoryItems_ItemId",
                        column: x => x.ItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockIns_ItemId_StockDate",
                table: "StockIns",
                columns: new[] { "ItemId", "StockDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockOuts_ItemId_StockDate",
                table: "StockOuts",
                columns: new[] { "ItemId", "StockDate" });
        }
